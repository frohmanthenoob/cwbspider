...
class AutomaticrainfallstationSpider(scrapy.Spider):
    name = 'automaticRainfallStation'
    allowed_domains = ['https://opendata.cwb.gov.tw/']
    start_urls = ['https://opendata.cwb.gov.tw/api/v1/rest/datastore/O-A0002-001?Authorization=CWB-30468991-9E32-4087-B504-1FEFFB0DF896']
    ...
    def parse(self, response):
        ...
        for data in flatdata:
            ...
            _dict.update({'mongodb_collection':'automaticRainfallStation'})
            yield _dict
